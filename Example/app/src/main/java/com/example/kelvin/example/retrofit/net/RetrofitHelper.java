package com.example.kelvin.example.retrofit.net;

import com.example.kelvin.example.R;
import com.example.kelvin.example.retrofit.net.stringconverter.StringConverterFactory;
...
public class RetrofitHelper {
            ...
            synchronized (Retrofit.class){
                if(null == retrofitInstance){ // 双重检验锁,仅第一次调用时实例化
                    retrofitInstance = new Retrofit.Builder()
                            ...
                            //添加String转换器，添加在Gson转换器之前
                            .addConverterFactory(buildStringConverterFactory())
                            // 集成Gson转换器
     ...
     * @return
     */
    private static StringConverterFactory buildStringConverterFactory(){
