package com.example.kelvin.example.glide;
...
import com.example.kelvin.example.glide.transform.CircleImageTransform;
import com.example.kelvin.example.glide.transform.RoundedCornersTransformation;
...
public class ImagesUtil {
    private static final int ERROR_IMAGE = R.mipmap.common_placehoder;
    private static final int AVATAR_IMAGE = R.mipmap.common_avatar;
